...
3. Analysis and visualization for extract customer behavior to build customer single view, analyze and make the decision
...
Customer single view is an aggregate customer data into single record. Conclude customer data in one location lead to reduce the duplicate of data and increase customer behavior understanding. 

Example of Customer single view
